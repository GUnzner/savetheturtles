...
function ready () {
    ...
    var removeCartItemsButton = document.getElementsByClassName('button-danger')
...
function addToCartClicked(event) {
    ...
    var imageSrc = shopItem.getElementsByClassName('image-donate')[0].src
...
function addItemToCart(title,price,imageSrc) {
    ...
    <img class="cart-item-image" width=100 src="${imageSrc}">
